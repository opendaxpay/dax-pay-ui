...
/**
 * 收银台配置 API（商户端）
 * 对接后端双路径 /mch/gateway/cashier-config
 */
export const CashierConfigApi = {
  ...
  list(params: {
    ...
    return defHttp.get({
      url: '/mch/gateway/cashier-config/list',
      params,
    });
  },
  ...
  getById(id: string): Promise<Result<CashierItemResult>> {
    return defHttp.get({
      url: '/mch/gateway/cashier-config/get-by-id',
      params: { id },
    });
  },
  ...
  save(data: CashierItemParam): Promise<Result<void>> {
    return defHttp.post({
      url: '/mch/gateway/cashier-config/save',
      data,
    });
  },
  ...
  update(data: CashierItemParam): Promise<Result<void>> {
    return defHttp.post({
      url: '/mch/gateway/cashier-config/update',
      data,
    });
  },
  ...
  delete(id: string): Promise<Result<void>> {
    return defHttp.post({
      url: '/mch/gateway/cashier-config/delete',
      params: { id },
    });
  },
};
