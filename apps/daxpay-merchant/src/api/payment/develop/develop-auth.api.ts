...
export const DevelopAuthApi = {
  ...
  generateAlipayAuthUrl(): Promise<Result<AuthUrlResult>> {
    return defHttp.post({ url: '/mch/develop/auth/generate-alipay-auth-url' });
  },
  ...
  generateWechatMpAuthUrl(): Promise<Result<AuthUrlResult>> {
    return defHttp.post({ url: '/mch/develop/auth/generate-wechat-mp-auth-url' });
  },
  ...
  generateDouyinAuthUrl(): Promise<Result<AuthUrlResult>> {
    return defHttp.post({ url: '/mch/develop/auth/generate-douyin-auth-url' });
  },
  ...
  generateChannelAuthUrl(data: ChannelAuthUrlParam): Promise<Result<AuthUrlResult>> {
    return defHttp.post({
      url: '/mch/develop/auth/generate-channel-auth-url',
      data,
    });
  },
  ...
  queryAuthResult(queryCode: string): Promise<Result<AuthResult>> {
    return defHttp.get({
      url: '/mch/develop/auth/query-auth-result',
      params: { queryCode },
    });
  },
};
