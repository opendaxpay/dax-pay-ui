<script lang="ts" setup>
  ...
  /** 发起转账: 跳转聚合发起页 */
  function openCreate() {
    router.push({ path: '/trade/transfer/create', query: { channel: 'alipay' } });
  }
  ...
  function handleRetry(row: AlipayTransferOrderResult) {
  ...
  <div class="m-3 p-3 bg-background rounded-lg list-page-compact">
    <a-card>
      <div class="mb-3 flex items-center justify-between">
        <span class="text-lg font-medium">{{ $t('menu.trade.transfer.alipay') }}</span>
