<script lang="ts" setup>
  ...
  import { isDouyinAppCompatible, resolveDouyinAppTypeByCapability } from './douyin-app-type';
  ...
  function loadData() {
    ...
    Promise.all([
      ...
      DouyinMchAppCapabilityApi.listByChannelMchNo(channelMchNo.value),
    ])
  ...
  >
    <a-spin :spinning="loading">
      ...
      <div v-if="!loading && !hasApps" class="mb-3">
        <a-alert type="warning" show-icon :message="$t('payment.channel.douyinManage.capabilityNoApp')" />
      </div>
