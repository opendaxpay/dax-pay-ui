<script lang="ts" setup>
  import type { WxMchApp } from '#/api/payment/wx/mch-app.api';
...
<template>
  <div class="mch-app-card group flex h-full min-h-[128px] flex-col rounded-xl border bg-card shadow-sm">
    ...
    <div class="card-footer flex shrink-0 items-center justify-end border-t border-border px-3 py-1.5">
      <div class="flex items-center">
        <a-tooltip
          v-if="hasPermission(PermCodes.Payment.Wx.MchApp.MANAGE)"
        ...
        <a-tooltip
          v-if="hasPermission(PermCodes.Payment.Wx.MchApp.VIEW)"
