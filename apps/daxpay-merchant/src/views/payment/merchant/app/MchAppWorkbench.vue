<script lang="ts" setup>
  ...
  type WorkbenchCard = {
    action?: 'cancelDefault' | 'delete' | 'edit' | 'notify' | 'setDefault';
    description: string;
    icon: string;
    key: string;
...
<template>
  ...
  <div v-else class="m-4">
    ...
    <a-spin :spinning="loading">
      <a-card variant="borderless" class="rounded-xl shadow-sm">
        ...
        <div class="space-y-10 py-2">
              ...
              >
                <div class="flex flex-col items-center text-center">
                  <div
                    ...
                    :class="isDangerCard(card) ? 'bg-destructive/10 text-destructive' : getIconBgClass(group.color)"
                  >
                  ...
                  <div
                    ...
                    :class="isDangerCard(card) ? 'text-destructive' : 'text-foreground group-hover:text-primary'"
                  >
                    {{ card.title }}
                  </div>
          ...
          <div v-if="functionCards.length === 0" class="py-16 text-center text-sm text-muted-foreground">
    ...
    <MchAppNotifyConfig v-model:visible="notifyDrawerVisible" :app-id="appInfo.appId" :app-name="appInfo.appName" />
  </div>
</template>
