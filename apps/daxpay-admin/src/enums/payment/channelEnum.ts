...
export const channelLogoMap: Record<string, string> = {
  ...
  [ChannelEnum.UNION_PAY]: 'unionPay',
  [ChannelEnum.LESHUA_PAY]: 'leshua',
  [ChannelEnum.VBILL_PAY]: 'vbillPay',
  [ChannelEnum.ADA_PAY]: 'adapay',
  [ChannelEnum.DOUGONG_PAY]: 'dougong',
  [ChannelEnum.DOUYIN_PAY]: 'douyinPay',
  [ChannelEnum.HKRT_PAY]: 'hkrtPay',
  [ChannelEnum.LAKALA_PAY]: 'lakala',
  [ChannelEnum.FUYOU_PAY]: 'fuyou',
  [ChannelEnum.SHENG_PAY]: 'shengPay',
  [ChannelEnum.YSEP_PAY]: 'ysepPay',
  [ChannelEnum.QUICK_PAY]: 'quickPay',
  [ChannelEnum.SAND_PAY]: 'sandPay',
  [ChannelEnum.YEE_PAY]: 'yeePay',
  [ChannelEnum.UMS_PAY]: 'umsPay',
  [ChannelEnum.JEE_PAY]: 'jeePay',
};
