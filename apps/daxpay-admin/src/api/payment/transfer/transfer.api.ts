...
export const TransferApi = {
  ...
  wechatPage(
    ...
    return defHttp.get({ url: '/admin/transfer/wechat/page', params });
  },

  /** 微信转账单详情 */
  wechatGetById(id: string): Promise<Result<WechatTransferOrderResult>> {
    return defHttp.get({ url: '/admin/transfer/wechat/get-by-id', params: { id } });
  },
  ...
  alipayPage(
    ...
    return defHttp.get({ url: '/admin/transfer/alipay/page', params });
  },

  /** 支付宝转账单详情 */
  alipayGetById(id: string): Promise<Result<AlipayTransferOrderResult>> {
    return defHttp.get({ url: '/admin/transfer/alipay/get-by-id', params: { id } });
  },

  /** 发起支付宝转账 */
  alipayCreate(data: TransferParam): Promise<Result<void>> {
    return defHttp.post({ url: '/admin/transfer/alipay/create', data });
  },
  ...
  douyinPage(
    ...
    return defHttp.get({ url: '/admin/transfer/douyin/page', params });
  },

  /** 抖音转账单详情 */
  douyinGetById(id: string): Promise<Result<DouyinTransferOrderResult>> {
    return defHttp.get({ url: '/admin/transfer/douyin/get-by-id', params: { id } });
  },

  /** 发起抖音转账 */
  douyinCreate(data: TransferParam): Promise<Result<void>> {
    return defHttp.post({ url: '/admin/transfer/douyin/create', data });
  },
  ...
  sync(channel: string, id: string): Promise<Result<void>> {
    return defHttp.post({ url: '/admin/transfer/sync', params: { channel, id } });
  },

  /** 关闭转账（仅通道支持场景有效） */
  close(channel: string, id: string): Promise<Result<void>> {
    return defHttp.post({ url: '/admin/transfer/close', params: { channel, id } });
  },
  ...
  tradePage(
    ...
    return defHttp.get({ url: '/admin/transfer/trade/page', params });
  },

  /** 转账记录详情 */
  tradeGetById(id: string): Promise<Result<TransferTradeResult>> {
    return defHttp.get({ url: '/admin/transfer/trade/get-by-id', params: { id } });
  },
};
