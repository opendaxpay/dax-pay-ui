<script lang="ts" setup>
  ...
  import {
    EasyPayChannelMerchantApi,
    type EasyPayChannelMerchantCreateParam,
  } from '#/api/payment/channel/easypay/channel-merchant.api';
  import ChannelLogo from '#/components/channel/ChannelLogo.vue';
  import { productI18nMap, productNameMap } from '#/enums/payment';
  import { useMessage } from '#/hooks/useMessage';

  defineOptions({ name: 'EasyPayMchCreateConfig' });
  ...
  function submit(param: Record<string, any>): Promise<any> {
    ...
    return EasyPayChannelMerchantApi.create(param as EasyPayChannelMerchantCreateParam);
  }
