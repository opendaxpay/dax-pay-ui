<script lang="ts" setup>
  import type { WechatIsvMchApp } from '#/api/payment/channel/wechat/isv-mch-app.api';
...
<template>
  <div class="wechat-isv-mch-app-card group flex h-full min-h-[128px] flex-col rounded-xl border bg-card shadow-sm">
