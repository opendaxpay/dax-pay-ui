<script lang="ts" setup>
  ...
  const formState = ref<WechatIsvMchApp>({
    appName: '',
  ...
  async function validateWxAppId() {
    ...
    return existsByServer(
      ...
      id,
      formEditType.value,
      (value) => WechatIsvMchAppApi.existsWxAppId(mchNo.value, channelMchNo.value, value),
      (value, excludeId) => WechatIsvMchAppApi.existsWxAppIdNotId(mchNo.value, channelMchNo.value, value, excludeId),
  ...
  function showEdit(no: string, mchChannelNo: string, record: WechatIsvMchApp) {
    mchNo.value = no;
    channelMchNo.value = mchChannelNo;
  ...
  async function handleOk() {
    ...
    confirmLoading.value = true;
    const payload: WechatIsvMchApp = {
      ...formState.value,
      mchNo: mchNo.value,
      channelMchNo: channelMchNo.value,
    };
    const request =
      formEditType.value === FormEditType.Edit ? WechatIsvMchAppApi.update(payload) : WechatIsvMchAppApi.add(payload);
    request
      .then(() => {
