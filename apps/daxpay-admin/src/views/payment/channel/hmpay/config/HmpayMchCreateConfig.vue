<script lang="ts" setup>
  ...
  import {
    ...
    type HmpayIsvChannelMerchantCreateParam,
  ...
  defineOptions({ name: 'HmpayMchCreateConfig' });
  ...
  const rules = computed(() => ({
    ...
    merchantNo: [{ required: true, message: $t('payment.channel.hmpayIsv.validation.merchantNo') }],
  }));
  ...
  function submit(param: Record<string, any>): Promise<any> {
    ...
    return HmpayChannelMerchantApi.create(param as HmpayIsvChannelMerchantCreateParam);
  }
        ...
        >
          ...
          <a-form-item :label="$t('payment.channel.hmpayIsv.merchantNo')" name="merchantNo">
            <a-input
              ...
              :placeholder="$t('payment.channel.hmpayIsv.merchantNoPlaceholder')"
            />
          </a-form-item>
