<script lang="ts" setup>
  ...
  import {
    ShengChannelMerchantApi,
    type ShengChannelMerchantCreateParam,
  } from '#/api/payment/channel/sheng/channel-merchant.api';
  import ChannelLogo from '#/components/channel/ChannelLogo.vue';
  import { productI18nMap, productNameMap } from '#/enums/payment';
  import { useMessage } from '#/hooks/useMessage';

  defineOptions({ name: 'ShengMchCreateConfig' });
  ...
  function submit(param: Record<string, any>): Promise<any> {
    ...
    return ShengChannelMerchantApi.create(param as ShengChannelMerchantCreateParam);
  }
