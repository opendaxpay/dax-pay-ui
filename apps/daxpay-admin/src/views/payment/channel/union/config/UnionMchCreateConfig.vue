<script lang="ts" setup>
  ...
  defineOptions({ name: 'UnionMchCreateConfig' });
  ...
  const rules = {
    ...
    merId: [{ required: true, message: $t('payment.channel.union.validation.merId') }],
  };
    ...
    <div v-if="!createSuccess">
      <a-spin :spinning="submitLoading">
        ...
        >
          ...
          <!-- 国际化: 银联商户号 -->
          <a-form-item :label="$t('payment.channel.union.merId')" name="merId">
            <a-input
              v-model:value="form.merId"
              :placeholder="$t('payment.channel.union.merIdPlaceholder')"
            />
          </a-form-item>
