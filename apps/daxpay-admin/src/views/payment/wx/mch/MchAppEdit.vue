<script lang="ts" setup>
  ...
  async function validateWxAppId() {
    ...
    return existsByServer(
      ...
      id,
      formEditType.value,
      (value) => WxMchAppApi.existsWxAppId(mchNo.value, value),
      (value, excludeId) => WxMchAppApi.existsWxAppIdNotId(mchNo.value, value, excludeId),
  ...
  function showEdit(no: string, record: WxMchApp) {
    mchNo.value = no;
