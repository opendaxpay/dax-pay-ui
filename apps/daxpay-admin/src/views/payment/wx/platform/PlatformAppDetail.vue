...
<template>
  <a-modal
    ...
    :title="modalTitle"
    width="100%"
    wrap-class-name="wx-platform-app-detail-modal"
    :footer="null"
...
<style>
  .wx-platform-app-detail-modal .ant-modal {
    top: 0;
    max-width: 100%;
    padding-bottom: 0;
    margin: 0;
  ...
  .wx-platform-app-detail-modal .ant-modal-content {
    display: flex;
  ...
  .wx-platform-app-detail-modal .ant-modal-body {
    flex: 1;
    overflow: hidden;
    padding: 16px 24px;
  }
