    ...
    <div class="security-module-page">
      <div class="module-overview">
        <div class="module-overview__header">
          <!-- 防重放校验标题 -->
          <div class="module-overview__title">{{ $t('system.security.iam-replay-protect.title') }}</div>
        ...
        <!-- 防重放校验描述 -->
        <div class="module-overview__desc">{{ $t('system.security.iam-replay-protect.description') }}</div>
